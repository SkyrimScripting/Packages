    ...
    on_config(function(target)
        ...
        depend.on_changed(function()
            ...
            if file then
                ...
                file:print("")
                file:print("const char* SKSEPluginInfo::GetPluginName() { return \"" .. config.name or target:name() .. "\"; }")
                file:print("")
                file:print("std::uint16_t SKSEPluginInfo::GetPluginVersionMajor() { return " .. version:major() .. "; }")
                file:print("std::uint16_t SKSEPluginInfo::GetPluginVersionMinor() { return " .. version:minor() .. "; }")
                file:print("std::uint16_t SKSEPluginInfo::GetPluginVersionPatch() { return " .. version:patch() .. "; }")
                file:print("")
