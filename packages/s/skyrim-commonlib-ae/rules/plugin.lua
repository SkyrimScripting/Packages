    ...
    on_config(function(target)
        ...
        depend.on_changed(function()
            ...
            if file then
                ...
                file:print("")
                file:print("#include <SKSE/SKSEPluginInfo.h>")
                file:print("")
                file:print("const char* SKSE::SKSEPluginInfo::GetPluginName() { return \"" .. target:name() .. "\"; }")
                file:print("")
                file:print("std::uint16_t SKSE::SKSEPluginInfo::GetPluginVersionMajor() { return " .. version:major() .. "; }")
                file:print("std::uint16_t SKSE::SKSEPluginInfo::GetPluginVersionMinor() { return " .. version:minor() .. "; }")
                file:print("std::uint16_t SKSE::SKSEPluginInfo::GetPluginVersionPatch() { return " .. version:patch() .. "; }")
                file:print("")
                file:print("#include <SKSE/SKSEPluginInfo/Extern/SKSEPlugin_Version.h>")
                file:print("#include <SKSE/SKSEPluginInfo/Extern/SKSEPlugin_Query.h>")
                file:close()
            end
