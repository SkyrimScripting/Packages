    ...
    on_config(function(target)
        ...
        depend.on_changed(function()
            ...
            if file then
                ...
                file:print("")
                file:print("// For access from your SKSE plugin")
                ...
                file:print("    using namespace std::literals;")
                file:print("    inline constexpr PluginName = \"" .. plugin_name .. "\"sv;")
                file:print("    inline constexpr AuthorName = \"" .. author_name .. "\"sv;")
                file:print("    inline constexpr AuthorEmail = \"" .. author_email .. "\"sv;")
                file:print("    inline constexpr REL::Version PluginVersion = { " .. version:major() .. ", " .. version:minor() .. ", " .. version:patch() .. " };")
                file:print("}")
                file:print("")
